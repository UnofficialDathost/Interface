<template>
  <div class="home">
    ...
    <div v-else>
      ...
      <draggable v-else @end="serverMoved" :force-fallback="true" ghost-class="ghost" drag-class="moved" draggable=".draggable-server" :list="serversDisplay" class="row gutter-2">
